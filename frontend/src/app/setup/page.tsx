...
const STEPS = [
  ...
  { id: 3, label: "Phone Setup", icon: Smartphone },
  { id: 4, label: "Test Call", icon: Play },
];
...
export default function SetupPage() {
  ...
  const handleFinish = async () => {
    setLoading("finish");
    try {
      await api.patch("/me", { phoneSetupStatus: "LIVE" });
    ...
    switch (currentStep) {
          ...
          >
            ...
            <div>
              ...
              <p className="text-[#6B6B8A] mt-3 leading-relaxed">
                This 4-step setup will get your AI calling system running in under 5 minutes.
              </p>
            </div>
            <div className="space-y-3 text-left bg-white/[0.03] rounded-xl p-5 border border-white/[0.06]">
              {[
                ...
                { icon: Smartphone, title: "Connect Phone Number", desc: "Attach an existing number or import one" },
                { icon: Play, title: "Test Call", desc: "Verify everything works with a test call to your phone" },
              ].map((item, i) => (
          ...
          >
            <div className="text-center mb-2">
              ...
              <p className="text-sm text-[#6B6B8A] mt-1">
                Create your voice agent that will call leads automatically.
              </p>
            </div>
            ...
            <div>
              <label className="block text-sm text-[#A0A0C0] mb-1.5">
                Knowledge Base <span className="text-[#4A4A62]">(optional)</span>
              </label>
              <textarea
                value={knowledgeBase}
              ...
              <p className="text-xs text-[#6B6B8A] mt-1.5">
                The AI uses this info to answer prospect questions naturally.
              </p>
        ...
        return (
          ...
          >
            <div className="text-center mb-2">
              ...
              <p className="text-sm text-[#6B6B8A] mt-1">
                Attach a phone number to your AI agent so it can call leads.
              </p>
            </div>
              ...
              <div className="bg-white/[0.03] rounded-xl p-6 border border-white/[0.06] text-center space-y-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#6B6B8A] mt-1">
                    Purchase a number from the Omnidimension dashboard, then refresh here.
                  </p>
                </div>
                <button
                  onClick={() => window.open("https://app.omnidim.io", "_blank")}
              ...
              <div className="space-y-2">
                {phoneNumbers.map((pn) => (
                  ...
                  >
                    ...
                    {selectedPhoneId === pn.id && (
                      <Check className="w-4 h-4 text-[#4F6EF7]" />
                    )}
                  </button>
                ))}
              </div>
      ...
      case 4:
        return (
          ...
          >
            <div className="text-center mb-2">
              <Play className="w-10 h-10 text-[#4F6EF7] mx-auto mb-2" />
              <h2 className="text-xl font-bold text-white">Test Your Setup</h2>
              <p className="text-sm text-[#6B6B8A] mt-1">
                We'll call your phone so you can hear how the AI sounds.
              </p>
            </div>
            ...
            <div className="bg-white/[0.03] rounded-xl p-6 border border-white/[0.06] text-center space-y-4">
              ...
              {testCallResult && (
                <p className="text-sm text-[#22D3A5]">
                  ✅ Test call initiated! Check your phone.
                </p>
              )}
            </div>
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0F] flex flex-col">
      ...
      {/* Progress Steps */}
      <div className="flex items-center justify-center gap-1 px-6 py-5 border-b border-[#2A2A3A]">
        {STEPS.map((step, i) => {
