        ...
        <div className="p-6 rounded-lg bg-[#111118] border border-[#2A2A3A]">
          {status === "loading" && (
            <div className="text-center py-6">
              <Loader2 className="w-8 h-8 mx-auto mb-4 text-[#4F6EF7] animate-spin" />
              <p className="text-[14px] text-[#6B6B8A]">Verifying your email…</p>
            </div>
          )}
          ...
          {status === "success" && (
            <div className="text-center py-6">
              ...
              <h2 className="text-[18px] font-display font-bold text-[#F0F0F8] mb-2">Email verified!</h2>
              <p className="text-[13px] text-[#6B6B8A] mb-2">Taking you to your dashboard…</p>
            </div>
          )}
          ...
          {status === "error" && (
            <div className="text-center py-6">
              ...
              <h2 className="text-[18px] font-display font-bold text-[#F0F0F8] mb-2">Verification failed</h2>
              <p className="text-[13px] text-[#6B6B8A] leading-relaxed mb-5">{error}</p>
              <Link
                href="/auth/login"
                className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg bg-[#4F6EF7] text-white text-[13px] font-semibold hover:brightness-110 transition-all"
              >
